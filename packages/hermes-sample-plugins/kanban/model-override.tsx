...
export function ModelOverrideField({
  ...
  return (
    <DropdownMenu onOpenChange={setOpen} open={open}>
      ...
      {/* `z-[140]`: this field's other home is the New Task DIALOG, and on
          hermes-universal DropdownMenuContent still carries shadcn's default
          `z-50` while DialogContent sits at `z-[130]` — so the menu opens
          BEHIND the dialog that asked for it. 140 is the rung the app's own
          Select already uses for exactly this. Harmless on the desktop app,
          whose dropdowns are portalled into the dialog itself. */}
      <DropdownMenuContent align="start" className="z-[140] w-72 p-0">
