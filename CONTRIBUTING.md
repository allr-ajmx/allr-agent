...
- Implement the relevant ABC and use the existing plugin discovery path (`~/.allr/plugins/`, project `.allr/plugins/`, or a pip entry point) — see [Build a Allr Plugin](https://allr.work/docs/guides/build-a-hermes-plugin)
