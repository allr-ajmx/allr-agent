#!/usr/bin/env python3
"""Build the Allr Model Catalog — a centralized JSON manifest of curated models.
...
Allr CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping an Allr release.
...
# Ensure ALLR_HOME is set for imports that touch it at module level.
os.environ.setdefault("ALLR_HOME", os.path.join(os.path.expanduser("~"), ".allr"))
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "allr-agent repo",
            "docs": "https://allr.work/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
                    ...
                    "note": (
                        ...
                        'The entry labeled "default": true is the model Allr '
