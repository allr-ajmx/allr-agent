#!/usr/bin/env python3
"""Build the Allr Skills Index — a centralized JSON catalog of all skills.
...
`allr skills search/install` can use it without hitting the GitHub API.
...
# Ensure ALLR_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Allr Skills Index...", flush=True)
