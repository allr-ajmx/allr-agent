#!/usr/bin/env python3
"""Summarize micro-compaction telemetry from Allr logs.
...
With no LOGFILE, reads ``$ALLR_HOME/logs/agent.log`` (default ~/.allr).
...
def default_log() -> Path:
    home = os.environ.get("ALLR_HOME") or str(Path.home() / ".allr")
