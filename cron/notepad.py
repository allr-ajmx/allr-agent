...
Write path is the CLI (``allr cron notepad <job_id> set <key> <value>``),
...
def render_notepad_section(job_id: str) -> str:
    ...
    return (
        ...
        f"`allr cron notepad {job_id} set <key> <value>` "
        f"(also: get/delete/list; `allr cron notepad {job_id} delete "
