"""Resolve ALLR_HOME for standalone skill scripts.

Skill scripts may run outside the Allr process (e.g. system Python,
...
instead of duplicating the ``ALLR_HOME = Path(os.getenv(...))`` pattern.
"""
...
try:
    ...
    def get_hermes_home() -> Path:
        """Return the Allr home directory (default: ~/.allr).
