/**
 * Allr desktop plugin template. Save as:
 *   <hermes home>/desktop-plugins/<id>/plugin.js   (folder name == id)
 * where <hermes home> is ~/.allr by default, or ~/.allr/profiles/<name>
 * when running a named profile (`hermes -p <name>`). Run `allr doctor` (or
