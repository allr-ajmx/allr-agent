...
This is an additive Allr extension surfaced under ACP ``_meta.hermes`` so
...
compression rotates the internal Allr head, ``build_session_provenance`` lets
...
def build_session_provenance(
    ...
    *,
    ...
    Args:
        ...
        current_hermes_session_id: The live internal Allr DB session id
