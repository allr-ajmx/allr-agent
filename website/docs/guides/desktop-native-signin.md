...
description: "How the Allr Desktop app signs in to a gated gateway using your system browser and PKCE — no embedded webview, no session cookies"
---

# Desktop Native Sign-In (RFC 8252)

When the Allr Desktop app connects to a **gated gateway** (a hosted or
...
For Allr specifically, native sign-in means:
...
- [Run Allr with Nous Portal](./run-hermes-with-nous-portal.md)
