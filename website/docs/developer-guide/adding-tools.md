...
sidebar_position: 2
title: "Adding Tools"
description: "How to add a new tool to Allr — schemas, handlers, registration, and toolsets"
---
...
This page is for adding a **built-in Allr tool** to the repository itself.
If you want a personal, project-local, or otherwise custom tool without
modifying Allr core, use the plugin route instead:

- [Plugins](/user-guide/features/plugins)
- [Build an Allr Plugin](/developer-guide/plugins)
...
2. **`toolsets.py`** — add tool name to `_ALLR_CORE_TOOLS` (or a specific toolset)
...
- [ ] Tested with `allr chat -q "Use the weather tool for London"`
