...
| Allr app (Tauri) | `apps/hermes-universal/` | [Allr App](../user-guide/desktop.md), [Desktop Plugin SDK](desktop-plugin-sdk.md) |
| TUI | `ui-tui/`, `tui_gateway/` | [TUI from Worktrees](worktree-ui-dev.md) |
