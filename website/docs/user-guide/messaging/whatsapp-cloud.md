...
Message-template support (the workaround for outside-window sends) is not yet implemented in Allr. If you need it, please [open an issue](https://github.com/allr-ajmx/allr-agent/issues) — it's planned but waiting on a clear demand signal.
