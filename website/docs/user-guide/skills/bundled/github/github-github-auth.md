...
- Give it a name like "allr-agent"
- Select scopes:
...
- Give it a title like "allr-agent-&lt;machine-name>"
...
elif _hermes_env="${ALLR_HOME:-$HOME/.allr}/.env"; [ -f "$_hermes_env" ] && grep -q "^GITHUB_TOKEN=" "$_hermes_env"; then
