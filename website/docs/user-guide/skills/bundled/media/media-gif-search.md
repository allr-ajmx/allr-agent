...
Set your Tenor API key in your environment (add to `${ALLR_HOME:-~/.allr}/.env`):
...
- GIF URLs can be used directly in markdown: `![alt](https://github.com/allr-ajmx/allr-agent/blob/main/skills/media/gif-search/url)`
