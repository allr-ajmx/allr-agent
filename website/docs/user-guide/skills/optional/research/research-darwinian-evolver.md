...
| | |
|---|---|
| Source | Optional — install with `allr skills install official/research/darwinian-evolver` |
| Path | `optional-skills/research/darwinian-evolver` |
| Version | `0.1.0` |
| Author | Bihruze (Asahi0x), Allr |
| License | MIT |
...
import upstream classes into Allr itself.
...
Open `~/.allr/cache/darwinian-evolver/darwinian_evolver/darwinian_evolver/lineage_visualizer.html`
...
7. **AGPL.** Never `from darwinian_evolver import ...` inside Allr core.
   Custom driver scripts under `~/.allr/skills/...` are user-side and fine.
