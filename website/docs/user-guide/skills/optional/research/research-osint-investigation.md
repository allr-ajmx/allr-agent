...
| | |
|---|---|
| Source | Optional — install with `allr skills install official/research/osint-investigation` |
...
# $ALLR_OSINT_CACHE/icij/ (default: ~/.cache/hermes-osint/icij/).
...
# Set ALLR_OSINT_UA=your-app/1.0 (your@email) to identify yourself
