...
| | |
|---|---|
| Source | Optional — install with `allr skills install official/creative/pixel-art` |
...
```python
import sys
sys.path.insert(0, "/home/teknium/.allr/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.allr/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Allr installs package this)
