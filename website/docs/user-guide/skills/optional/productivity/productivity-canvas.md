...
| | |
|---|---|
| Source | Optional — install with `allr skills install official/productivity/canvas` |
...
4. Name the token (e.g., "Allr"), set an optional expiry, and click **Generate Token**
5. Copy the token and add to `${ALLR_HOME:-~/.allr}/.env`:
