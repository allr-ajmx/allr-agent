...
| | |
|---|---|
| Source | Optional — install with `allr skills install official/data-science/jupyter-notebook` |
...
| `execute_code` | One-shot scripts needing Allr tool access (web_search, file ops). Stateless. |
