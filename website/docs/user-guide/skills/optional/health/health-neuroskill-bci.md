...
| | |
|---|---|
| Source | Optional — install with `allr skills install official/health/neuroskill-bci` |
...
Connect Allr to a running [NeuroSkill](https://neuroskill.com/) instance to read
