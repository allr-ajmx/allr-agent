...
| | |
|---|---|
| Source | Optional — install with `allr skills install official/blockchain/solana` |
| Path | `optional-skills/blockchain/solana` |
| Version | `0.2.0` |
| Author | Deniz Alagoz (gizdusum), enhanced by Allr |
| License | MIT |
...
Helper script path: ~/.allr/skills/blockchain/solana/scripts/solana_client.py
