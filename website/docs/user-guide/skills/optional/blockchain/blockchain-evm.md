...
| | |
|---|---|
| Source | Optional — install with `allr skills install official/blockchain/evm` |
| Path | `optional-skills/blockchain/evm` |
| Version | `1.0.0` |
| Author | Mibayy (@Mibayy), youssefea (@youssefea), ethernet8023 (@ethernet8023), Allr |
| License | MIT |
...
Helper script path: `~/.allr/skills/blockchain/evm/scripts/evm_client.py`
