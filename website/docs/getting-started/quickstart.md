...
- **[Moving to another machine](/reference/faq#exporting-allr-to-another-machine)** — `allr backup` migrates your whole setup (or [a single profile](/reference/faq#moving-a-single-profile-to-another-machine)); no need to rebuild from scratch
