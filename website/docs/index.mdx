...
| 🧭 **[Use MCP with Allr](/guides/use-mcp-with-allr)**               | Practical MCP setup patterns, examples, and tutorials                 |
| 🎙️ **[Voice Mode](/user-guide/features/voice-mode)**                    | Real-time voice interaction in CLI, Telegram, Discord, and Discord VC |
| 🗣️ **[Use Voice Mode with Allr](/guides/use-voice-mode-with-allr)** | Hands-on setup and usage patterns for Allr voice workflows          |
