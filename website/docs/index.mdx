...
slug: /
sidebar_position: 0
title: "Allr Documentation"
description: "Allr is one AI workspace that makes finished work — decks, docs, videos, websites, apps, and games."
...
Allr is one AI workspace that makes finished work — decks, docs, videos, websites, apps, and games. It runs as an agent runtime and gateway you host yourself, with a cross-platform app for desktop, Android and iOS. Allr is a fork of [NousResearch/hermes-agent](https://github.com/NousResearch/hermes-agent) (MIT).
...
After installing, run `allr setup --portal` — one OAuth covers a model plus all four Tool Gateway tools (web search, image generation, TTS, browser). See [Nous Portal](/integrations/nous-portal).
:::
...
| 🔌 **[MCP Integration](/user-guide/features/mcp)**                      | Connect to MCP servers, filter their tools, and extend Allr safely  |
| 🧭 **[Use MCP with Allr](/guides/use-mcp-with-hermes)**               | Practical MCP setup patterns, examples, and tutorials                 |
| 🎙️ **[Voice Mode](/user-guide/features/voice-mode)**                    | Real-time voice interaction in CLI, Telegram, Discord, and Discord VC |
| 🗣️ **[Use Voice Mode with Allr](/guides/use-voice-mode-with-hermes)** | Hands-on setup and usage patterns for Allr voice workflows          |
| 🎭 **[Personality & SOUL.md](/user-guide/features/personality)**        | Define Allr' default voice with a global SOUL.md                    |
...
| 💡 **[Tips & Best Practices](/guides/tips)**                            | Quick wins to get the most out of Allr                              |
...
- **Built by model trainers** — Created by [Nous Research](https://nousresearch.com), the lab behind Hermes, Nomos, and Psyche. Works with [Nous Portal](https://portal.nousresearch.com), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint <!-- # rebrand:keep: Nous's model family, not this product -->
...
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Built by [Nous Research](https://nousresearch.com) — the lab behind Hermes, Nomos, and Psyche models <!-- # rebrand:keep: Nous's model family, not this product -->
