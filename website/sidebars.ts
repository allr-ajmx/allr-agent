...
const sidebars: SidebarsConfig = {
  docs: [
    ...
    },
    {
      ...
      collapsed: true,
      items: [
        'guides/run-allr-with-nous-portal',
        'guides/tips',
        ...
        'guides/use-mcp-with-allr',
        'guides/use-soul-with-allr',
        'guides/use-voice-mode-with-allr',
        ...
        'guides/desktop-native-signin',
        'guides/troubleshooting-agent-quality',
        'guides/secure-allr-on-a-work-machine',
      ],
    },
    {
      type: 'category',
