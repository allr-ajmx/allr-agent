# nix/overlays.nix — Expose pkgs.allr-agent for external NixOS configs
#
...
# `pkgs.allr-agent`, `nix build .#default`, and the NixOS module's
...
{ inputs, ... }:
{
  flake.overlays.default = final: _: {
    allr-agent = inputs.self.packages.${final.stdenv.hostPlatform.system}.default;
  };
}
