...
def build_backup_parser(subparsers, *, cmd_backup: Callable) -> None:
    ...
    backup_parser = subparsers.add_parser(
        "backup",
        help="Back up Allr home directory to a zip file",
        description="Create a zip archive of your entire Allr configuration, "
        "skills, sessions, and data (excludes the allr-agent codebase). "
