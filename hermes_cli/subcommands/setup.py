...
def build_setup_parser(subparsers, *, cmd_setup: Callable) -> None:
    ...
    setup_parser = subparsers.add_parser(
        ...
        description="Configure Allr with an interactive wizard. "
        "Run a specific section: "
        "allr setup model|tts|terminal|gateway|tools|telemetry|agent",
    )
    ...
    setup_parser.add_argument(
        ...
        "compatibility — a bare 'allr setup' now does this.",
    )
    setup_parser.add_argument(
        "--quick",
        action="store_true",
