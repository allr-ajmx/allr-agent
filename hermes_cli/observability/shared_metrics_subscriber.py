"""Relay subscriber for the persisted Allr shared-metrics slice."""
...
class SharedMetricsSubscriber:
    """Persist validated Allr counters from Relay lifecycle events."""
    ...
    def __call__(self, event: Any) -> None:
        ...
        with self._lock:
            ...
            try:
                ...
                logger.warning(
                    "Unable to persist the Allr shared metric: %s",
                    metric_name,
                    exc_info=True,
                )
