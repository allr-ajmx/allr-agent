...
Entry point: ``allr whatsapp-cloud`` (dispatched from
...
Allr gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures Allr to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  Allr needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the Allr gateway in another terminal:")
    print("         allr gateway")
    print()
    ...
    print()
    print("  Docs: https://allr.work/docs/user-guide/")
