"""Allr middleware contract helpers.
...
OBSERVER_SCHEMA_VERSION = "allr.observer.v1"
MIDDLEWARE_SCHEMA_VERSION = "allr.middleware.v1"
...
def apply_llm_request_middleware(
    ...
    **context: Any,
    ...
    provider kwargs before Allr sends them.
    """
