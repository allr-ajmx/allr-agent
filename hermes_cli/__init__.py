"""
Allr CLI - Unified command-line interface for Allr.

Provides subcommands for:
- allr chat          - Interactive chat (same as ./allr)
- allr gateway       - Run gateway in foreground
- allr gateway start - Start gateway service
...
def _ensure_utf8():
    ...
    can even start — e.g. `allr setup` on a fresh Pi.
