...
Used by ``allr profile describe <name> --auto`` and the dashboard's
...
_SYSTEM_PROMPT = """You are a profile-describer for the Allr kanban board.
...
Rules:
  ...
  - Never write "Allr profile" or other meta-narration.
