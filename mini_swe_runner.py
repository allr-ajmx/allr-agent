#!/usr/bin/env python3
"""
SWE Runner with Allr Trajectory Format

A runner that uses Allr's built-in execution environments
(local, docker, modal) and outputs trajectories in the Allr format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Allr's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Allr format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Allr format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Allr's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Allr Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Allr's built-in execution environments
    and outputs trajectories in Allr format.
    """
    ...
    def _convert_to_hermes_format(
        ...
        """
        Convert internal message format to Allr trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Allr trajectory format
...
def main(
    ...
    """
    Run SWE tasks with Allr trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Allr Trajectory Format")
    print("=" * 60)
