...
AlexKucera reported on Discord (2026-04-16) that after ``allr update`` pulled
...
Opt-in — not part of default CI:
    ALLR_LIVE_TESTS=1 pytest tests/run_agent/test_sequential_chats_live.py -v

Requires ``OPENROUTER_API_KEY`` to be set (or sourced via ~/.allr/.env).
"""
