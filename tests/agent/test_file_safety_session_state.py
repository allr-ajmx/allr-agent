...
manipulation. Allr keeps canonical conversation history in state.db and may
...
def fake_homes(tmp_path, monkeypatch):
    """Point ALLR_HOME at a temp profile dir.
    ...
    ALLR_HOME=<root>/profiles/<name> makes get_default_hermes_root()
