...
CA bundle env vars (ALLR_CA_BUNDLE, REQUESTS_CA_BUNDLE, SSL_CERT_FILE)
...
_CA_ENV_VARS = ("ALLR_CA_BUNDLE", "REQUESTS_CA_BUNDLE", "SSL_CERT_FILE")
...
class TestResolveRequestsVerify:
    ...
    def test_priority_hermes_over_requests(self, clean_env, tmp_path, bundle_file):
        ...
        clean_env.setenv("ALLR_CA_BUNDLE", bundle_file)
