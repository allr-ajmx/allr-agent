...
#
# `allr-setup` always invokes `allr update --yes --gateway`, whose
...
@pytest.mark.parametrize(
    ...
    [
        ...
        r"C:\Users\u\AppData\Local\hermes\allr-agent\venv\Scripts\python.exe"
...
def test_main_gateway_with_long_managed_runtime_path_is_exempt(monkeypatch, capsys):
    ...
    """
    long_exe = (
        r'"C:\Users\u\AppData\Local\hermes\allr-agent\.hermes-runtime\python'
