...
def test_timezone_honors_managed(homes, monkeypatch):
    ...
    monkeypatch.delenv("ALLR_TIMEZONE", raising=False)
...
def test_gateway_env_bridge_honors_managed(homes, monkeypatch):
    ...
    every turn (ALLR_TIMEZONE, ALLR_REDACT_SECRETS, ALLR_MAX_ITERATIONS,
    ...
    # writing ALLR_TIMEZONE = cfg["timezone"]. Prove the overlay flips the value.
    import yaml
