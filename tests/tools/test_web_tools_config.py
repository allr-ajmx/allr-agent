...
class TestBackendSelection:
    ...
    ``allr tools``.  Falls back to key-based detection for legacy/manual
    setups.
    """
...
class TestFirecrawlEnvResolution:
    ...
    values stored in ~/.allr/.env were invisible to the provider."""
...
class TestSiblingProvidersEnvResolution:
    ...
    ~/.allr/.env), not bare os.getenv. Parametrized over the four
