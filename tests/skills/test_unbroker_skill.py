...
# Resolve the skill's scripts dir across layouts: standalone dev repo (tests/) and allr-agent
...
_CANDIDATES = [
    ...
    _HERE.parent.parent.parent.joinpath(*_REL),          # allr-agent (tests/skills/)
]
