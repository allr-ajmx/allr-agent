...
binary download are exercised manually by `allr secrets bitwarden
...
def hermes_home(tmp_path, monkeypatch):
    """Point Allr at an isolated home directory."""
    home = tmp_path / ".allr"
    home.mkdir()
    monkeypatch.setenv("ALLR_HOME", str(home))
    # Some modules cache get_hermes_home; clear if needed.
    import hermes_constants
    if hasattr(hermes_constants, "_ALLR_HOME_CACHE"):
        hermes_constants._ALLR_HOME_CACHE = None  # type: ignore[attr-defined]
    return home
