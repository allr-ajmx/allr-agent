"""
A2A (Agent-to-Agent) plugin for Allr.

Registers:
  - The ``a2a`` platform adapter (inbound: exposes Allr as an A2A agent,
    protocol v1.0).
...
def interactive_setup() -> None:
    """`allr gateway setup` flow for A2A."""
    ...
    print_info("Expose Allr as an A2A-discoverable agent and call other A2A agents.")
