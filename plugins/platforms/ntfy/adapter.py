"""ntfy platform adapter (Allr plugin).
...
_ECHO_TAG = "allr-agent"  # tag added to outgoing messages for echo-loop prevention
...
async def _standalone_send(
    ...
    *,
    ...
    ``allr cron`` running standalone). Without this hook,
