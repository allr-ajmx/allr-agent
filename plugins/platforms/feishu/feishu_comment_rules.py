...
Config: ~/.allr/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.allr/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_hermes_home()`` helper (ALLR_HOME-aware and
