...
export default function ProgressScreen({ bootstrap }: ProgressProps) {
  ...
  const title = bootstrap.status === 'completed' ? 'Done' : isUpdate ? 'Updating Allr' : 'Setting up Allr'

  const description = isUpdate
    ? 'Allr is updating to the latest version — this only takes a moment.'
    : 'This is a one-time setup. The Allr installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.'
