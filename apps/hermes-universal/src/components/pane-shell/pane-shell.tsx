...
// adjacent pane's scrollbar (0.5rem) — the strip overlays the neighboring
// scroller's edge, so any overlap makes the scrollbar reveal the pane on hover
  ...
  if (overlayActive) {
    ...
    return (
      ...
      >
        <div
          aria-hidden="true"
          className="pointer-events-auto absolute inset-y-0 z-30"
