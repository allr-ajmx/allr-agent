...
export const titleMenuTriggerVariants = cva(
  'group/title-trigger pointer-events-auto relative flex min-w-0 max-w-full gap-1 overflow-hidden border-0 bg-transparent px-2 py-0 text-left text-(--ui-text-secondary) hover:text-foreground [-webkit-app-region:no-drag]',
  {
    variants: {
      density: {
        desktop: 'h-6',
