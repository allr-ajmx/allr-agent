...
export const en: Translations = {
  ...
  settings: {
    ...
    gateway: {
      ...
      intro:
        'Choose how Allr connects. Use a local backend on this device, sign in to Allr Cloud, or point this app at an already-running Allr backend on another machine or behind a trusted proxy.',
      ...
      cloudSignInTitle: 'Allr Cloud',
      cloudSignIn: 'Sign in to Allr Cloud',
      cloudSignedIn: 'Signed in to Allr Cloud',
      cloudNeedsSignIn: 'Sign in to Allr Cloud to discover the agents on your account.',
      ...
      cloudDiscoverFailed: 'Could not load your Allr Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'Allr Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of Allr Cloud',
      cloudSignedOutMessage: 'Cleared the Allr Cloud session.',
