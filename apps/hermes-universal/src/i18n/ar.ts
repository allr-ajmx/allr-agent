...
// Arabic (العربية). RTL — see `languages.ts` for the direction table and
// `i18n/context.tsx` for where `dir` reaches the document.
//
// A PARTIAL locale, deliberately: `defineLocale` merges these over English, so
// a key nobody has translated yet falls back to a readable English string
// instead of blocking the whole locale on a complete pass. Seeded from
// `apps/desktop/src/i18n/ar.ts` — every string there that universal also has a
// key for, and nothing invented.
...
export const ar = defineLocale({
  ...
  notifications: {
    ...
    backendOutOfDateMessage: 'خلفية Allr أقدم من إصدار سطح المكتب الحالي وقد لا تعمل كما يجب. حدثهما ليتوافقا.',
    updateHermes: 'تحديث Allr',
    ...
    errors: {
      ...
      methodNotAllowed: 'رفضت خلفية سطح المكتب هذا الطلب (405 Method Not Allowed). جرب إعادة تشغيل Allr Desktop.',
    ...
    native: {
      ...
      inputBody: 'ينتظر Allr ردّك.',
      turnDoneTitle: 'أنهى Allr',
      turnDoneBody: '',
  ...
  settings: {
    ...
    resetConfirm: 'هل تريد إعادة كل الإعدادات إلى افتراضيات Allr؟',
    ...
    plugins: {
      ...
      blurb:
        'امتدادات واجهة تُحمّل داخل هذا التطبيق — إما مضمّنة مع البناء، أو موضوعة في مجلد desktop-plugins (بما فيها التي يكتبها Allr). تعطيل الإضافة يفرغها مباشرة ويبقى بعد إعادة التشغيل.',
      count: n => `${n} مثبتة`,
    ...
    notifications: {
      ...
      focusedHint: 'تنبيهات الاكتمال تظهر فقط عندما يكون Allr في الخلفية.',
      kinds: {
        approval: {
          label: 'يلزم الموافقة',
        ...
        input: {
          label: 'يلزم إدخال',
          description: 'طرح Allr سؤالا أو يحتاج إلى كلمة مرور أو سر.'
        },
        turnDone: {
          label: 'الرد جاهز',
          description: 'انتهى دور بينما كان Allr في الخلفية.'
        },
        turnError: {
          label: 'فشل الدور',
    ...
    voiceLevels: {
      title: 'المستويات',
      intro:
        'اضبط مدى حساسية Allr لصوتك ومدى ارتفاع صوته عند الرد. لا يوجد إلغاء للصدى هنا، لذا فإن ضبط عتبة المقاطعة فوق ما تسجله مكبرات الصوت هو ما يمنع Allr من مقاطعة نفسه.',
      meterTitle: 'مقياس الإدخال',
      meterDesc: 'افتح الميكروفون لترى مستواك مقابل العتبات أدناه. لا يتم تسجيل أي شيء ولا إرساله.',
      meterRunningDesc:
        'قيد الاستماع. تحدث بشكل طبيعي، ثم اضبط عتبة الإدخال أسفل مستوى كلامك مباشرة. يتوقف تلقائيا بعد دقيقة.',
      meterStart: 'اختبار الميكروفون',
      meterStop: 'إيقاف',
      meterLevel: (percent: string) => `المستوى ${percent}`,
      meterPeak: (percent: string) => `الذروة ${percent}`,
      meterBusy: 'الميكروفون قيد الاستخدام بالفعل',
      meterFailed: 'تعذر فتح الميكروفون',
      saveFailed: 'تعذر حفظ مستوى الصوت',
      gainTitle: 'كسب الإدخال',
      gainDesc: 'يضاعف المستوى المقاس حتى يبلغ ميكروفون منخفض الصوت العتبات. لا يغير الصوت الذي يُفرَّغ نصيا.',
      thresholdTitle: 'عتبة الإدخال',
      thresholdDesc:
        'مدى ارتفاع الصوت اللازم قبل أن يعتبره Allr بداية دورك. المنخفضة جدا تستجيب لضجيج الغرفة، والمرتفعة جدا لا تسمعك أبدا.',
      bargeinTitle: 'عتبة المقاطعة',
      bargeinDesc:
        'البوابة الأعلى التي تُطبَّق أثناء تحدث Allr. أبقها فوق ما يعرضه المقياس عندما تعمل مكبرات الصوت وحدها.',
      outputSectionTitle: 'الإخراج',
      outputTitle: 'مستوى صوت النطق',
      outputDesc: 'مدى ارتفاع تشغيل الردود المنطوقة.'
    },
    sections: {
      model: 'النموذج',
      chat: 'المحادثة',
    ...
    appearance: {
      ...
      backdropDesc: 'اختيار مقدار مزج خلفية سطح المكتب مع سطح Allr.',
      reactionsTitle: 'تفاعلات الرسائل',
      reactionsDesc: 'تفاعلات إيموجي بأسلوب iMessage — تفاعل مع الرسائل، ويمكن لـ Allr التفاعل مع رسائلك.',
      ...
      pet: {
        title: 'حيوان أليف',
        intro:
          'تبنَّ تعويذة petdex متحركة تطفو فوق التطبيق وتتفاعل مع ما يفعله Allr — تجري أثناء تنفيذ الأدوات، وتحتفل عند النجاح، وتعبس عند الأخطاء.',
        restartHint:
          'تحتاج الحيوانات الأليفة إلى إعادة تشغيل سريعة — بدأ التطبيق العامل قبل إضافة هذه الميزة. أغلق Allr وأعد فتحه، ثم ارجع إلى هنا.',
        on: 'تشغيل',
        off: 'إيقاف',
        scaleTitle: 'الحجم',
    ...
    fieldDescriptions: {
      ...
      timezone: 'تستخدم عندما يحتاج Allr إلى سياق الوقت المحلي. اتركها فارغة لاستخدام منطقة النظام.',
      'agent.imageInputMode': 'يتحكم في طريقة إرسال مرفقات الصور إلى النموذج.',
      'agent.maxTurns': 'الحد الأعلى لدورات استدعاء الأدوات قبل أن يوقف Allr التشغيل.',
      ...
      fileReadMaxChars: 'أقصى عدد أحرف يستطيع Allr قراءته من ملف واحد في الطلب.',
      'approvals.mode': 'كيف يتعامل Allr مع الأوامر التي تحتاج موافقة صريحة.',
      ...
      'updates.nonInteractiveLocalChanges':
        'عندما يحدّث Allr نفسه من التطبيق دون موجه طرفية، احتفظ بتعديلات المصدر المحلية أو تجاهلها.'
    },
    about: {
      heading: 'حول Allr',
      description:
        'Allr منصة تتطوّر باستمرار لتجعل العمل مع الذكاء الاصطناعي أبسط. فبدلاً من أن نطلب منك إتقان استخدام الذكاء الاصطناعي، نحسّن نحن البنية المحيطة به — لتحصل على أفضل ما يمكن أن يقدّمه النموذج وبأفضل أداء. ومع جمع حزمة التطبيقات كاملةً في مكان واحد، يبقى تركيزك على النتيجة التي تريدها لا على طريقة الوصول إليها.',
      ...
      automaticUpdatesDesc: 'اسمح لـ Allr بالتحقق من التحديثات وتثبيتها.',
    ...
    config: {
      ...
      loading: 'جار تحميل إعدادات Allr...',
      ...
      backgroundModeDesc:
        'إغلاق النافذة يخفي Allr بدلاً من إنهائه، فتستمر الجلسة الجارية في البث. استخدم أيقونة شريط النظام لإظهاره أو لإنهائه.',
      backgroundModeFailed: 'تعذّر إبقاء Allr يعمل في الخلفية'
    },
    credentials: {
    ...
    gateway: {
      ...
      intro:
        'يشغّل Allr Desktop بوابة محلية خاصة افتراضياً. استخدم بوابة بعيدة عندما تريد أن يتحكم هذا التطبيق بخلفية Allr تعمل مسبقاً على جهاز آخر أو خلف وكيل موثوق.',
      appliesTo: 'ينطبق على',
      ...
      envOverrideDesc: 'أزل ALLR_DESKTOP_REMOTE_URL و ALLR_DESKTOP_REMOTE_TOKEN لاستخدام الإعداد المحفوظ أدناه.',
      localTitle: 'بوابة محلية',
      localDesc: 'تشغيل خلفية Allr خاصة على localhost. هذا هو الافتراضي ويعمل دون اتصال.',
      remoteTitle: 'بوابة بعيدة',
      remoteDesc:
        'صل واجهة سطح المكتب هذه بخلفية Allr بعيدة. البوابات المستضافة تستخدم OAuth أو اسم مستخدم وكلمة مرور، والبوابات الذاتية قد تستخدم رمز جلسة.',
      ...
      restartingMessage: 'سيعيد Allr Desktop الاتصال باستخدام الإعدادات المحفوظة.',
      savedMessage: 'تم الحفظ للتشغيل القادم.',
      connectedTo: (baseUrl, version) => `متصل بـ ${baseUrl}${version ? ` \xB7 Allr ${version}` : ''}`,
      ...
      allrTitle: 'Allr Work',
      allrDesc: 'سجّل الدخول بحساب Allr Work وسنعثر على مساحة عملك تلقائيًا، دون الحاجة إلى لصق أي رابط.',
      allrIntro: 'سجّل الدخول مرة واحدة. يعثر Allr على مساحة عملك ويربط هذا الجهاز بها.',
      allrSignIn: 'تسجيل الدخول إلى Allr Work',
      allrSigningIn: 'جارٍ تسجيل الدخول إلى Allr Work…',
      allrSigningInHint: 'أكمل الخطوات في النافذة التي فُتحت. أغلقها للإلغاء.',
      allrResuming: 'جارٍ إكمال تسجيل الدخول إلى Allr Work…',
      allrConnectedTo: host => `متصل بمساحة عملك على ${host}`,
      allrSwitchAccount: 'تبديل الحساب',
      allrSessionEnded: 'انتهت جلسة Allr Work. سجّل الدخول مرة أخرى لإعادة الاتصال.',
      allrUnreachable:
        'تعذّر الوصول إلى مساحة عمل Allr Work. أعد المحاولة، أو سجّل الدخول مرة أخرى إذا استمرت المشكلة.',
      allrTryAgain: 'إعادة المحاولة',
      allrSignInAgain: 'تسجيل الدخول مرة أخرى',
      allrSignedOutMessage: 'تم تسجيل الخروج من Allr Work على هذا الجهاز.',
      allrWorkspaceTarget: host => (host ? `مساحة عمل Allr Work على ${host}` : 'مساحة عمل Allr Work'),
      allrError: {
        invalidPortalConfig: 'عنوان Allr Work المُعدّ لهذا التطبيق غير صالح.',
        timedOut: 'استغرق تسجيل الدخول وقتًا طويلًا. أعد المحاولة.',
        navigationRefused: 'تعذّر فتح صفحة تسجيل الدخول على هذا الجهاز.',
        alreadyOnSignInPage: 'صفحة تسجيل الدخول مفتوحة بالفعل. أكملها أو ارجع أولًا.',
        portalRefused: 'تعذّر على Allr Work التحقق من هويتك. أعد المحاولة.',
        noWorkspaceForAccount: 'لا توجد مساحة عمل Allr Work لهذا الحساب. بدّل إلى الحساب الذي أُعدّت به مساحة عملك.',
        portalOutdated: 'تسجيل الدخول عبر Allr Work غير متاح بعد لهذه الخدمة. أعد المحاولة لاحقًا.',
        stateMismatch: 'لم تتطابق استجابة تسجيل الدخول مع هذا الطلب. أعد المحاولة.',
        invalidWorkspace: 'أعاد Allr Work عنوانًا لن يتصل به هذا التطبيق.',
        workspaceUnsupported: 'مساحة عملك لا تدعم تسجيل الدخول من التطبيق بعد.',
        unreachable: 'تعذّر الوصول إلى Allr Work. تحقّق من اتصالك وأعد المحاولة.',
        workspaceRefusedSignIn: 'رفضت مساحة عملك تسجيل الدخول. أعد المحاولة.',
        credentialNotSaved: 'تم تسجيل الدخول، لكن تعذّر على هذا الجهاز تخزين بيانات الاعتماد بأمان.',
        cookieStoreFailed: 'تم تسجيل الخروج، لكن قد تظل صفحة تسجيل الدخول تتذكر حسابك.',
        busy: 'هناك عملية تسجيل دخول قيد التنفيذ بالفعل.'
      }
    },
    keys: {
    ...
    providers: {
      ...
      intro: 'سجل الدخول باشتراكك دون نسخ مفتاح API. يشغّل Allr تسجيل الدخول من المتصفح لك داخل التطبيق.',
      connected: 'متصل',
      collapse: 'طي',
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'أعد تشغيل Allr لاستخدام الحيوانات الأليفة — الخادم الخلفي أقدم من هذه الميزة.',
    ...
    generatePet: {
      ...
      staleBackend: 'حدّث Allr لتوليد الحيوانات الأليفة.',
      backgroundHint: 'يمكنك إغلاق هذا — سيُعلِمك Allr عند الانتهاء.',
    ...
    hermesActiveSessions: (version, count) => `Allr ${version} لديه ${count} جلسة نشطة`,
  ...
  profiles: {
    ...
    soulPlaceholder: mode => `الموجّه (prompt) النظامي / الشخصية لهذا الملف الشخصي.
اتركه فارغا للإبقاء على افتراضي ${mode}.`,
  ...
  cron: {
    ...
    emptyDescNew: 'أنشئ مهمة مجدولة لتشغيل Allr تلقائيا.',
    ...
    createDesc: 'اضبط مهمة يشغلها Allr تلقائيا.',
    nameLabel: 'الاسم',
    namePlaceholder: 'مثال: الملخص الصباحي',
    promptLabel: 'الرسالة',
    promptPlaceholder: 'ماذا تريد من Allr أن يفعل؟',
  ...
  sidebar: {
    ...
    filters: {
      trigger: 'عوامل التصفية',
      grouping: 'التجميع',
      groupingSessions: 'الجلسات',
      groupingProject: 'المشاريع',
      ordering: 'الترتيب',
      orderUpdated: 'آخر تحديث',
      ...
      metaTokens: 'الرموز',
      metaCost: 'التكلفة',
      sectionLabel: 'عوامل التصفية',
      status: 'الحالة',
      statusNeedsInput: 'بحاجة إلى رد',
      statusWorking: 'قيد التنفيذ',
    ...
    projects: {
      ...
      deleteConfirm: 'هذا يزيل المشروع المحفوظ من Allr. تبقى الملفات ومستودعات git وأشجار العمل دون تغيير.',
  ...
  composer: {
    ...
    placeholderStarting: 'جار بدء Allr...',
    placeholderReconnecting: 'جار إعادة الاتصال...',
    placeholderFollowUp: 'اكتب متابعة...',
    newSessionPlaceholders: ['اسأل Allr عن شيء...', 'اطلب من Allr تنفيذ مهمة...', 'ابدأ محادثة جديدة...'],
    ...
    urlHintPre: 'سيقرأ Allr الرابط ضمن السياق.',
    attach: 'إرفاق',
  ...
  updates: {
    stages: {
      ...
      pydeps: 'جار الإنهاء...',
      update: 'جار تحديث Allr...',
      rebuild: 'جار إعادة بناء تطبيق سطح المكتب...',
      restart: 'جار إعادة تشغيل Allr...',
      done: 'اكتمل التحديث',
    ...
    unsupportedMessage: 'لا يمكن لهذا الإصدار من Allr تحديث نفسه من داخل التطبيق.',
    ...
    availableBody: 'إصدار جديد من Allr جاهز للتثبيت.',
    availableTitleBackend: 'يتوفر تحديث للواجهة الخلفية',
    availableBodyBackend: 'إصدار أحدث من واجهة Allr الخلفية المتصلة جاهز للتثبيت.',
    ...
    manualBody: 'لقد ثبّتت Allr من سطر الأوامر، لذا تُجرى التحديثات من هناك أيضا. الصق هذا في طرفيتك:',
    manualPickedUp: 'سيلتقط Allr الإصدار الجديد في المرة التالية التي تشغّله فيها.',
    guiSkewTitle: 'تحديث تطبيق سطح المكتب',
    guiSkewBody:
      'تم تحديث الواجهة الخلفية، لكن حزمة تطبيق سطح المكتب هذه لم تتغير. حدّث أو أعد تثبيت تطبيق Allr لسطح المكتب (ملف AppImage / ‎.deb / ‎.rpm) لمطابقته.',
    copy: 'نسخ',
    copied: 'تم النسخ',
    done: 'تم',
    applyingBody:
  ...
  install: {
    ...
    oneTimeTitle: 'يحتاج Allr إلى تثبيت لمرة واحدة',
    ...
    settingUpTitle: 'جار إعداد وكيل Allr',
    finishingTitle: 'جار الإنهاء',
    failedDesc:
      'فشلت إحدى خطوات التثبيت. على Windows، قد يحدث هذا إذا كان هناك نسخة أخرى من Allr CLI أو تطبيق سطح المكتب قيد التشغيل. أوقف أي نسخ Allr قيد التشغيل، ثم أعد المحاولة. تحقق من التفاصيل أدناه أو من سجل سطح المكتب للحصول على النص الكامل.',
    activeDesc:
      'هذا إعداد لمرة واحدة. يقوم مثبّت Allr بتنزيل التبعيات وتهيئة جهازك. ستتخطى عمليات التشغيل اللاحقة هذه الخطوة.',
  ...
  onboarding: {
    headerTitle: 'لنُعِدّ لك Allr',
    headerDesc: 'اربط مزوّد نماذج لبدء المحادثة. معظم الخيارات تتطلب نقرة واحدة.',
    preparingInstall: 'يُكمل Allr التثبيت. عادة ما يستغرق ذلك أقل من دقيقة في أول تشغيل.',
    starting: 'جار بدء Allr...',
    ...
    recommended: 'موصى به',
    connected: 'متصل',
    featuredPitch: 'اشتراك واحد، أكثر من 300 نموذج متقدم — الطريقة الموصى بها لتشغيل Allr',
    ...
    flowSubtitles: {
      ...
      device_code: 'يفتح صفحة تحقق في المتصفح — يتصل Allr تلقائياً',
    ...
    authorizeThere: 'صرّح لـ Allr هناك.',
    copyAuthCode: 'انسخ رمز التفويض وألصقه أدناه.',
    pasteAuthCode: 'ألصق رمز التفويض',
    reopenAuthPage: 'إعادة فتح صفحة التفويض',
    autoBrowser: provider => `فتحنا ${provider} في المتصفح. صرّح لـ Allr هناك وسيتم الاتصال تلقائياً دون نسخ أو لصق.`,
    ...
    noDefaultModel:
      'تعذّر على Allr اختيار نموذج افتراضي لهذا المزوّد. تم حفظ بيانات الاعتماد — اختر نموذجًا من الإعدادات ← النموذج.',
  ...
  preview: {
    ...
    largeBody: (label, size) => `حجم ${label} هو ${size}. سيعرض Allr أول 512 KB فقط.`,
    ...
    web: {
      ...
      tryAgain: 'إعادة المحاولة',
      restarting: 'جار إعادة تشغيل Allr...',
      askRestart: 'اطلب من Allr إعادة تشغيل الخادم',
      lookingRestart: taskId => `يبحث Allr عن خادم معاينة لإعادة تشغيله (${taskId})`,
      restartingTitle: 'جار إعادة تشغيل خادم المعاينة',
      restartingMessage: 'يعمل Allr في الخلفية. راقب كونسول المعاينة لمتابعة التقدم.',
      ...
      finishedRestarting: message => `أنهى Allr إعادة تشغيل خادم المعاينة${message ? `: ${message}` : ''}`,
  ...
  desktop: {
    ...
    handoff: {
      ...
      timedOut: 'انتهت المهلة في انتظار البوابة. هل `allr gateway` قيد التشغيل؟'
    }
  },
  errors: {
  ...
  tray: {
    ...
    tooltip: 'Allr',
    closeDialogTitle: 'هل تريد إبقاء Allr في الخلفية؟',
    closeDialogDesc:
      'اختر إبقاء Allr يعمل في الخلفية عند إغلاق هذه النافذة، أو إنهاءه تمامًا. يمكنك تغيير ذلك في أي وقت من الإعدادات أو من قائمة شريط النظام.',
  ...
  webhooks: {
    title: 'الويب هوك',
    loading: 'جارٍ تحميل الويب هوك…',
    loadFailed: 'فشل تحميل الويب هوك',
    search: 'ابحث في الاشتراكات…',
    noMatches: 'لا توجد اشتراكات مطابقة لهذا البحث.',
    tabInbound: 'وارد',
    tabOutbound: 'صادر',
    outboundSubtitle: 'يُضبط في config.yaml',
    outboundTitle: 'الويب هوك الصادر',
    outboundBody:
      'يستطيع Allr إرسال أحداث موقّعة بـ HMAC إلى عناوينك عبر خطافات دورة حياة الجلسة. تُضبط في config.yaml تحت `hooks.outbound:` — ولا توفّر البوابة أي واجهة برمجية لها، لذا لا يوجد ما يُدار من هنا بعد.',
    emptyTitle: 'لا توجد اشتراكات بعد',
    emptyDesc: 'يمنح الاشتراك خدمةً خارجية عنوانًا ترسل إليه الأحداث، ويحدّد ما يفعله الوكيل عند وصول حدث.',
    emptyDescDisabled: 'فعّل مستقبل الويب هوك قبل إنشاء اشتراك — ترفض البوابة الإنشاء ما دامت المنصة متوقفة.',
    newSubscription: 'اشتراك جديد',
    enableFirst: 'فعّل مستقبل الويب هوك أولًا.',
    rowActions: 'إجراءات الاشتراك',
    enableRow: 'تفعيل',
    disableRow: 'تعطيل',
    showSecret: 'إظهار السر',
    secretUnsaved: 'السر غير محفوظ',
    ...
    fieldDescriptionPlaceholder: 'الغرض من هذا الاشتراك (اختياري)',
    fieldPrompt: 'الموجّه',
    fieldPromptPlaceholder: 'ما ينبغي أن يفعله الوكيل عند التشغيل (اختياري)',
    fieldEvents: 'الأحداث',
    fieldEventsPlaceholder: 'مفصولة بفواصل؛ اتركها فارغة لمطابقة كل حدث',
    fieldSkills: 'المهارات',
    fieldSkillsPlaceholder: 'أسماء مهارات مفصولة بفواصل (اختياري)',
    fieldDeliver: 'التسليم إلى',
    fieldDeliverChatId: 'معرّف محادثة التسليم',
    fieldDeliverChatPlaceholder: 'معرّف المحادثة / القناة للتسليم إليها (اختياري)',
    fieldDeliverChatDisabled: 'اختر وجهة تسليم أولًا',
    fieldDeliverOnly: 'تسليم الحمولة فقط',
    fieldDeliverOnlyHint: 'مرّر الحدث الخام إلى الوجهة دون تشغيل الوكيل.',
    fieldSecret: 'سر التوقيع',
    fieldSecretPlaceholder: 'اتركه فارغًا لتوليد واحد',
    fieldSecretHint: 'السر المولَّد يُعرض مرة واحدة فقط. زوّد سرك الخاص لتحتفظ بنسخة منذ البداية.',
    fieldCreated: 'أُنشئ في',
    fieldScript: 'السكربت',
    secretSet: 'مضبوط (مخفي)',
    secretMissing: 'غير مضبوط',
    createHint: 'يصبح الاسم مسار العنوان، لذا يُحوَّل إلى أحرف صغيرة وتصير المسافات شرطات.',
    create: 'إنشاء',
    creating: 'جارٍ الإنشاء…',
    createFailed: 'تعذّر إنشاء الاشتراك',
    created: (name: string) => `تم إنشاء "${name}"`,
    nameRequired: 'الاسم مطلوب.',
    nameInvalid: 'استخدم أحرفًا لاتينية صغيرة وأرقامًا وشرطات وشرطات سفلية، على أن يبدأ بحرف أو رقم.',
    nameNormalized: (name: string) => `سيُنشأ باسم "${name}".`,
    deliverOnlyNeedsTarget: 'تسليم الحمولة فقط يحتاج وجهة حقيقية — اختر شيئًا غير السجل.',
    createdTitle: (name: string) => `سر "${name}"`,
    secretOnce: 'سر التوقيع',
    secretOnceWarning: 'هذه المرة الوحيدة التي يُعرض فيها هذا السر. تخفيه البوابة في كل قراءة بعد ذلك.',
    secretCopiedHint: 'نُسخ إلى الحافظة. الصقه في مكان آمن قبل الإغلاق.',
    secretNotCopiedHint: 'لم يُنسخ بعد. إذا تعذّرت الحافظة، حدّد القيمة وانسخها يدويًا.',
    secretRecovery: 'أضعته؟ احذف هذا الاشتراك وأنشئه من جديد — أو زوّد سرك الخاص في المرة القادمة.',
    secretLater: 'ليس بعد',
    secretSaved: 'حفظته',
    enabledRow: (name: string) => `تم تفعيل "${name}"`,
    disabledRow: (name: string) => `تم تعطيل "${name}"`,
    toggleFailed: (name: string) => `تعذّر تغيير "${name}"`,
    deleteTitle: 'حذف الاشتراك',
    deleteDescPrefix: 'سيؤدي هذا إلى الإزالة النهائية لـ ',
    deleteDescSuffix: '، مع سر التوقيع الخاص به. لا يمكن التراجع عن ذلك.',
    deleting: 'جارٍ الحذف…',
    deleted: 'تم حذف الاشتراك',
    deleteFailed: (name: string) => `تعذّر حذف "${name}"`,
    disabledTitle: 'مستقبل الويب هوك متوقف',
    disabledBody:
      'الويب هوك منصة بوابة مستقلة. فعّلها لقبول أحداث HTTP الواردة؛ ولا تحتاج قنوات المحادثة إلا عندما يسلّم اشتراك إليها.',
    enable: 'تفعيل الويب هوك',
    enabling: 'جارٍ التفعيل…',
    enableFailed: 'تعذّر تفعيل منصة الويب هوك',
    enabledRestartStarted:
      'مُفعَّل في الإعدادات، وبدأت إعادة تشغيل البوابة. لن يقبل المستقبل أي أحداث حتى تكتمل إعادة التشغيل.',
    restartNotStarted: (detail: string) =>
      `مُفعَّل في الإعدادات، لكن إعادة تشغيل البوابة لم تبدأ${detail} أعد تشغيلها بنفسك حتى يعمل المستقبل.`,
    restartGateway: 'إعادة تشغيل البوابة',
    restarting: 'جارٍ إعادة التشغيل…',
    receiverNotLiveTitle: 'المستقبل لا يقبل الأحداث',
    receiverNotLive: (state: string) =>
      `تُبلّغ البوابة أن حالة منصة الويب هوك هي "${state}". الاشتراكات أدناه محفوظة، لكن لا شيء يستمع بعد.`,
    receiverUnknown:
      'لا تُبلّغ هذه البوابة عن حالة المنصات، لذا لا يمكن التأكد هنا مما إذا كان المستقبل يستمع فعلًا — فقط أنه مُفعَّل في الإعدادات.',
    pendingRestartBody:
      'الويب هوك مُفعَّل في الإعدادات، لكن البوابة العاملة بدأت قبل هذا التغيير ولم تفتح المستقبل. أعد تشغيلها.',
