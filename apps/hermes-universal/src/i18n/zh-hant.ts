...
export const zhHant = defineLocale({
  ...
  keybinds: {
    title: '鍵盤快速鍵',
    globalTag: '系統層級',
    globalTagHint: '啟動時向作業系統取得：Allr 在背景時也會觸發，本機上的其他應用程式無法使用這組按鍵。',
    globalClaimTitle: '已在系統層級保留一組快速鍵',
    globalClaimMessage: combos =>
      `Allr 已向作業系統取得 ${combos}，因此其他應用程式在前景時也會回應。Allr 執行期間其他應用程式無法使用它。`,
  ...
  notifications: {
    ...
    backendOutOfDateMessage: '您的 Allr 後端早於目前的桌面版本，可能無法正常運作。請更新以保持一致。',
    installMethodUnsupportedTitle: '不受支援的安裝方式',
    updateHermes: '更新 Allr',
    ...
    errors: {
      ...
      methodNotAllowed: '桌面後端拒絕了該請求 (405 Method Not Allowed)。請嘗試重新啟動 Allr Desktop。',
    ...
    native: {
      ...
      rejectAction: '拒絕',
      inputTitle: '需要輸入',
      inputBody: 'Allr 正在等待你的回應。',
      turnDoneTitle: 'Allr 已完成',
      turnDoneBody: '回覆已就緒。',
      turnErrorTitle: '本輪失敗',
  ...
  hud: {
    connecting: '正在連線至 Allr…',
    connectionFailed: 'Allr 無法連線至閘道。',
    expandReply: '顯示回覆',
    collapseReply: '隱藏回覆'
  },
  ...
  settings: {
    ...
    resetConfirm: '要將所有設定恢復為 Allr 預設值嗎？',
    exportFailed: '匯出失敗',
    resetFailed: '重設失敗',
    nav: {
      providers: '提供方',
    ...
    plugins: {
      ...
      agent: {
        title: '代理外掛',
        blurb:
          '執行於 Allr 後端——工具、技能、MCP 伺服器、掛鉤與斜線指令。「可攜」外掛是 Agent Plugins 標準套件（技能 + MCP 組合，也可在其他代理中使用）。開關於新工作階段生效。',
        empty: '尚未安裝代理外掛。',
        loadFailed: '無法載入代理外掛',
        portable: '可攜',
        search: '搜尋外掛…',
        ...
        updateBackendToManage: '請更新 Allr 後端，才能在這裡開啟或關閉此外掛。',
    ...
    notifications: {
      ...
      focusedHint: '完成提醒僅在 Allr 位於背景時觸發。',
      kinds: {
        approval: {
          label: '需要核准',
        ...
        input: {
          label: '需要輸入',
          description: 'Allr 提出了問題，或需要密碼或密鑰。'
        },
        turnDone: {
          label: '回覆就緒',
          description: 'Allr 在背景時完成了一輪對話。'
        },
        turnError: {
          label: '本輪失敗',
          description: '本輪以錯誤結束。'
        ...
        plugin: {
          label: '外掛通知',
          description: 'Allr 位於背景時，外掛送出了通知。'
        }
      },
      test: '傳送測試通知',
      testTitle: 'Allr',
    ...
    voiceLevels: {
      title: '電平',
      intro:
        '調整 Allr 聽你說話的靈敏度以及朗讀回覆的音量。這裡沒有回音消除，因此把插話門檻設在喇叭所產生的電平之上，才能避免 Allr 打斷自己。',
      meterTitle: '輸入電平表',
      ...
      thresholdTitle: '輸入門檻',
      thresholdDesc: '聲音要多大，Allr 才會視為你開始說話。過低會被環境噪音觸發，過高則完全聽不到你。',
      bargeinTitle: '插話門檻',
      bargeinDesc: 'Allr 說話期間套用的較高門檻。請保持它高於僅有喇叭發聲時電平表顯示的數值。',
    ...
    appearance: {
      ...
      pet: {
        title: '寵物',
        intro:
          '領養一隻懸浮在應用上的 petdex 動畫寵物，它會根據 Allr 的狀態做出反應——工具執行時奔跑、成功時歡呼、出錯時沮喪。',
        restartHint: '寵物功能需要重新啟動——目前執行的應用在此功能加入前啟動。請結束並重新開啟 Allr，然後回到此處。',
        scaleTitle: '大小',
    ...
    fieldDescriptions: defineFieldCopy({
      ...
      timezone: 'Allr 需要本機時間上下文時使用。留空則使用系統時區。',
      agent: {
        imageInputMode: '控制圖片附件如何傳送給模型。',
        maxTurns: 'Allr 停止一次執行前的工具呼叫輪次上限。'
      },
      terminal: {
      ...
      fileReadMaxChars: 'Allr 單次檔案讀取可讀取的最大字元數。',
      approvals: {
        mode: 'Allr 如何處理需要明確批准的指令。',
      ...
      updates: {
        nonInteractiveLocalChanges:
          'Allr 從應用程式內更新自身時，保留本機原始碼變更（stash）或丟棄（discard）。終端機更新一律會詢問。'
      }
    }),
    about: {
      heading: 'Allr',
      ...
      automaticUpdatesDesc: 'Allr 會在背景自動檢查更新，並在有可用更新時通知你。',
    ...
    config: {
      ...
      backgroundModeDesc: '關閉視窗只會收起 Allr 而不結束，進行中的回覆會繼續輸出。可透過系統匣圖示重新顯示或結束。',
      backgroundModeFailed: '無法讓 Allr 在背景繼續執行'
    },
    credentials: {
      pasteKey: '貼上金鑰',
    ...
    gateway: {
      sshInstallTitle: host => `在 ${host} 上安裝 Allr？`,
      sshInstallBody: 'Allr 將安裝在該主機的使用者帳戶中，不需要管理員權限。',
      sshInstallCancel: '暫不',
      sshInstallDoneTitle: '已在該主機上安裝 Allr',
      ...
      envOverride: '環境變數覆寫',
      intro:
        'Allr Desktop 預設會啟動自己的本機閘道。如果您希望此應用程式控制另一台機器或可信代理後面已執行的 Allr 後端，請使用遠端閘道。在下方按設定檔指定各自的遠端主機。',
      appliesTo: '套用至',
      allProfiles: '全部設定檔',
      ...
      envOverrideDesc: '取消設定 ALLR_DESKTOP_REMOTE_URL 和 ALLR_DESKTOP_REMOTE_TOKEN 後才會使用下方儲存的設定。',
      localTitle: '本機閘道',
      ...
      authTitle: '驗證',
      sessionKindNative: '系統瀏覽器',
      sessionKindNativeHint: '您透過系統瀏覽器登入。權杖保存在此裝置的金鑰環中，不會進入應用程式的網頁檢視。',
      sessionKindCookie: '應用程式內',
      sessionKindCookieHint: '您在應用程式內登入。工作階段 Cookie 由應用程式保存並自動重新整理。',
      ...
      configFloorWarning: (version, floor) =>
        `設定 v${version} 早於支援下限 v${floor}，已不再自動遷移。請備份上方 Allr 主目錄中的 config.yaml 並執行 \`allr setup\` 重新產生，或在查閱變更日誌後設定 _config_version: ${floor}。`,
      openLogs: '開啟記錄',
      ...
      savedTitle: '閘道設定已儲存',
      restartingMessage: 'Allr Desktop 將使用已儲存的設定重新連線。',
      savedMessage: '已儲存，下次重新啟動後生效。',
      connectedTo: (baseUrl, version) => `已連線至 ${baseUrl}${version ? ` · Allr ${version}` : ''}`,
      ...
      switchFailed: '切換閘道失敗',
      sessionMissingTitle: '閘道已變更',
      sessionMissingMessage: '此工作階段在新閘道上不存在。',
      saveFailed: '無法儲存閘道設定',
      ...
      startOver: '重新開始',
      allrTitle: 'Allr Work',
      allrDesc: '使用你的 Allr Work 帳戶登入——系統會為你找到工作區，無需貼上 URL。',
      allrIntro: '只要登入一次。Allr 會找到你的工作區，並將此裝置連線至該工作區。',
      allrSignIn: '登入 Allr Work',
      allrSigningIn: '正在登入 Allr Work…',
      allrSigningInHint: '請在開啟的視窗中完成操作。關閉該視窗即可取消。',
      allrResuming: '正在完成 Allr Work 登入…',
      allrConnectedTo: host => `已連線至位於 ${host} 的工作區`,
      allrSwitchAccount: '切換帳戶',
      allrSessionEnded: '你的 Allr Work 工作階段已結束。請重新登入以重新連線。',
      allrUnreachable: '無法連線至你的 Allr Work 工作區。請重試；若問題持續發生，請重新登入。',
      allrTryAgain: '重試',
      allrSignInAgain: '重新登入',
      allrSignedOutMessage: '已在此裝置上登出 Allr Work。',
      allrWorkspaceTarget: host => (host ? `位於 ${host} 的 Allr Work 工作區` : '你的 Allr Work 工作區'),
      allrError: {
        invalidPortalConfig: '此應用程式設定的 Allr Work 位址無效。',
        timedOut: '登入耗時過久。請重試。',
        navigationRefused: '無法在此裝置上開啟登入頁面。',
        alreadyOnSignInPage: '已有登入頁面開啟中。請先完成登入或返回。',
        portalRefused: 'Allr Work 無法確認你的身分。請重試。',
        noWorkspaceForAccount: '此帳戶沒有 Allr Work 工作區。請切換至設定工作區時使用的帳戶。',
        portalOutdated: '此服務尚不支援 Allr Work 登入。請稍後再試。',
        stateMismatch: '登入回應與此要求不符。請重試。',
        invalidWorkspace: 'Allr Work 傳回了此應用程式不會連線的位址。',
        workspaceUnsupported: '你的工作區尚不支援從應用程式登入。',
        unreachable: '無法連線至 Allr Work。請檢查網路連線後重試。',
        workspaceRefusedSignIn: '你的工作區拒絕了此次登入。請重試。',
        credentialNotSaved: '已登入，但此裝置無法安全地儲存憑證。',
        cookieStoreFailed: '已登出，但登入頁面可能仍會記住你的帳戶。',
        busy: '已有登入正在進行中。'
      }
    },
    keys: {
    ...
    model: {
      ...
      moaEnabled: '啟用',
      moaPresetDisabledHint: '此預設已停用 — 無論下方開關如何，都只由彙整模型作答，不會執行任何參考模型。',
    ...
    providers: {
      ...
      intro: '使用訂閱登入，無需複製 API 金鑰。Allr 會在應用程式中為您完成瀏覽器登入。',
      connected: '已連線',
      collapse: '收合',
    ...
    customEndpoints: {
      ...
      editTitle: '編輯端點',
      emptyTitle: '尚無自訂端點',
      emptyDescription: '在下方新增一個相容 OpenAI 的端點。',
      active: '使用中',
      ...
      apiKeyLabel: 'API 金鑰',
      apiKeyPlaceholderNew: '選填',
      apiKeyPlaceholderEdit: '留空以保留目前金鑰',
      ...
      saved: '自訂端點已儲存。',
      saveFailed: '儲存失敗',
      reachableWithModels: count => `端點可連線。找到 ${count} 個模型。`,
      reachable: '端點可連線。',
      validationFailed: '端點驗證失敗。',
  ...
  skills: {
    ...
    skillArchivedMessage: '可透過 allr curator restore 還原。',
    mcp: {
      loading: '正在載入 MCP 伺服器…',
  ...
  starmap: {
    ...
    loading: '載入中…',
    emptyTitle: '尚無學習內容',
    emptyDesc: '當 Allr 為你的工作建立技能與記憶時，會顯示在這裡。'
  },
  agents: {
    close: '關閉代理',
    title: '派生樹',
  ...
  commandCenter: {
    ...
    goToSession: '前往工作階段',
    projects: '專案',
    openFolder: '將資料夾作為專案開啟…',
    openFolderAt: path => `將資料夾作為專案開啟 — ${path}`,
    branches: '分支',
    ...
    pets: {
      ...
      staleBackend: '請重新啟動 Allr 以使用寵物功能。',
      empty: '沒有符合的寵物。',
      turnOff: '關閉',
      turnOn: '開啟',
      installed: '已安裝',
    ...
    generatePet: {
      ...
      staleBackend: '請更新 Allr 以生成寵物。',
      backgroundHint: '你可以關閉此視窗——完成後 Allr 會通知你。',
    ...
    nav: {
      ...
      settings: { title: '設定', detail: '設定 Allr 桌面端' },
    ...
    hermesActiveSessions: (version, count) => `Allr ${version} · 活躍工作階段 ${count}`,
  ...
  profiles: {
    ...
    exported: '已匯出設定檔',
    imported: '已匯入設定檔',
    failedExport: '無法匯出該設定檔',
    failedImport: '無法匯入該設定檔',
    shareHint: '會連同主題與版面配置一起打包技能、設定與 SOUL.md。絕不包含憑證。',
    copying: '複製中…',
    modelLabel: '模型',
    skillsLabel: '技能',
    notSet: '未設定',
    ...
    deleting: '刪除中…',
    createDesc: '設定檔是獨立的 Allr 環境：各自擁有獨立的設定、技能和 SOUL.md。',
    nameLabel: '名稱',
    cloneFrom: '複製來源',
    cloneFromNone: '無（空白）',
  ...
  cron: {
    ...
    newCron: '新排程工作',
    emptyDescNew: '按 cron 表達式排程一個提示詞。Allr 會執行它，並將結果傳送至您選擇的目的地。',
  ...
  sidebar: {
    ...
    projects: {
      ...
      ideaAppended: 'IDEA.md 已存在 — 你的想法已附加到檔案結尾',
      ideaKeptExisting: '已保留原有的 IDEA.md — 檔案過大或不是文字檔',
      noFolders: '尚未新增資料夾。',
      addFolder: '新增資料夾',
      primaryBadge: '主要',
      removeFolder: '移除',
      ...
      createFailed: '無法建立專案',
      staleBackend: '請更新 Allr 後端以建立專案——目前後端比桌面應用舊（設定 → 更新 → 後端）。',
      deleteConfirm: '這會從 Allr 中移除已儲存的專案。檔案、git 儲存庫和工作樹維持不變。',
      startWork: '新增工作樹',
  ...
  composer: {
    ...
    placeholderStarting: '正在啟動 Allr...',
    placeholderReconnecting: '正在重新連線至 Allr…',
    ...
    attachUrlDesc: 'Allr 將擷取該頁面並作為此回合的脈絡。',
  ...
  updates: {
    ...
    unsupportedMessage: '此版本的 Allr 無法在應用程式內自行更新。',
    connectionRetry: '請檢查網路連線後重試。',
    latestBody: '您正在執行最新版本。',
    latestBodyBackend: '後端正在執行最新版本。',
    allSetTitle: '已是最新版本',
    availableTitle: '有可用更新',
    availableBody: '新版 Allr 已可安裝。',
    availableTitleBackend: '後端有可用更新',
    availableBodyBackend: '已連接的 Allr 後端有新版本可安裝。',
    availableBodyNoChangelog: '已有新版本可用。此安裝方式無法顯示更新日誌。',
    updateNow: '立即更新',
    maybeLater: '稍後再說',
    moreChanges: count => `另有 ${count} 項變更。`,
    manualTitle: '從終端機更新',
    manualBody: '您是從命令列安裝的 Allr，因此更新也需要在那裡執行。請將此指令貼到終端機：',
    manualPickedUp: '下次啟動 Allr 時會使用新版本。',
    guiSkewTitle: '請更新桌面應用程式',
    guiSkewBody:
      '後端已更新，但此桌面應用程式套件未變更。請更新或重新安裝 Allr 桌面應用程式（你的 AppImage / .deb / .rpm）以保持一致。',
    copy: '複製',
    copied: '已複製',
    done: '完成',
  ...
  install: {
    ...
    failedTitle: '安裝失敗',
    settingUpTitle: '正在設定 Allr',
    finishingTitle: '正在收尾',
    failedDesc:
      '某個安裝步驟失敗。在 Windows 上，如果另一個 Allr CLI 或桌面執行個體正在執行，可能會出現這種情況。請停止正在執行的 Allr 執行個體後重試。可查看下方的詳細資訊或 desktop 記錄中的完整記錄。',
    activeDesc: '這是一次性設定。Allr 安裝程式正在下載相依套件並設定您的電腦。之後啟動會略過此步驟。',
  ...
  connect: {
    welcomeTitle: '歡迎使用 Allr',
    welcomeBody: 'Allr 可以執行在你需要的任何地方——本機、雲端，或透過 SSH 連線的機器。選擇一個閘道，我們來完成連線。',
    getStarted: '開始使用',
    chooseTitle: '選擇閘道',
    ...
    local: {
      ...
      retry: '重試',
      doneTitle: 'Allr 已就緒',
      doneBody: '設定將在下一階段推出。你現在就可以開始使用 Allr。',
      done: '完成',
      continue: '繼續'
    }
  },
  ...
  onboarding: {
    headerTitle: '開始設定 Allr',
    headerDesc: '連線模型提供方即可開始聊天。大多數選項只需一次點擊。',
    preparingInstall: 'Allr 正在完成安裝。首次執行通常不到一分鐘。',
    starting: '正在啟動 Allr…',
    ...
    recommended: '建議',
    connected: '已連線',
    featuredPitch: '一個訂閱，300+ 前沿模型 — 執行 Allr 的建議方式',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: '自託管',
        description: '將 Allr 指向本機或自託管的 OpenAI 相容端點（vLLM、llama.cpp、Ollama 等）。'
      }
    },
    backToSignIn: '返回登入',
    getKey: '取得金鑰',
    ...
    flowSubtitles: {
      ...
      device_code: '在瀏覽器中開啟驗證頁面 — Allr 會自動連線',
    ...
    authorizeThere: '請在那裡授權 Allr。',
    copyAuthCode: '複製授權碼並貼到下方。',
    pasteAuthCode: '貼上授權碼',
    reopenAuthPage: '重新開啟授權頁面',
    autoBrowser: provider => `已在瀏覽器中開啟 ${provider}。請在那裡授權 Allr，連線會自動完成，無需複製或貼上。`,
    ...
    copy: '複製',
    defaultModel: '預設模型',
    noDefaultModel: 'Allr 無法為該供應商選擇預設模型。憑證已儲存 — 請在設定 → 模型中選擇一個。',
    freeTier: '免費層',
    pro: 'Pro',
    free: '免費',
  ...
  rightSidebar: {
    ...
    remoteFilePickerTitle: '選擇遠端檔案',
    remoteFilePickerDescription: '瀏覽已連線後端上的檔案。',
  ...
  preview: {
    ...
    largeTitle: '此檔案較大',
    largeBody: (label, size) => `${label} 大小為 ${size}。Allr 只會顯示前 512 KB。`,
    previewAnyway: '仍然預覽',
    ...
    web: {
      ...
      failedToLoad: '預覽載入失敗',
      tryAgain: '重試',
      restarting: 'Allr 正在重新啟動...',
      askRestart: '請 Allr 重新啟動伺服器',
      lookingRestart: taskId => `Allr 正在尋找要重新啟動的預覽伺服器 (${taskId})`,
      restartingTitle: '正在重新啟動預覽伺服器',
      restartingMessage: 'Allr 正在背景執行。可在預覽主控台查看進度。',
      ...
      finishedRestarting: message => `Allr 已完成預覽伺服器重新啟動${message ? `：${message}` : ''}`,
      failedRestarting: message => `伺服器重新啟動失敗：${message}`,
      unknownError: '未知錯誤',
      restartedTitle: '預覽伺服器已重新啟動',
      reloadingNow: '正在重新載入預覽。',
      restartFailedTitle: '預覽重新啟動失敗',
      restartFailedMessage: 'Allr 無法重新啟動伺服器。',
      stillWorking: 'Allr 仍在執行，但尚未收到重新啟動結果。伺服器指令可能正在前台執行。',
  ...
  assistant: {
    ...
    approval: {
      gatewayDisconnected: 'Allr 閘道未連線',
      sendFailed: '無法傳送核准回應',
      run: '執行',
      command: '指令',
      moreOptions: '更多核准選項',
      ...
      alwaysDescription: pattern =>
        `這會將「${pattern}」模式加入永久允許清單（~/.allr/config.yaml）。Allr 對類似指令將不再詢問，包括目前工作階段和未來工作階段。`,
      alwaysAllow: '一律允許'
    },
    clarify: {
      notReady: '澄清請求尚未就緒',
      ...
      expiredAnswer: '此提問在您的回答送達前已逾時 — 已改為草擬成後續訊息。'
    },
    tool: {
      code: '程式碼',
      copyCode: '複製程式碼',
  ...
  prompts: {
    ...
    sudoTitle: '管理員密碼',
    sudoDesc: 'Allr 需要您的 sudo 密碼來執行特權指令。它只會傳送給您的本機代理。',
    sudoPlaceholder: 'sudo 密碼',
    secretTitle: '需要密鑰',
    secretDesc: 'Allr 需要一個憑證才能繼續。',
  ...
  desktop: {
    ...
    restoreEmpty: '無法還原空白訊息。',
    restoreNoSession: '沒有可還原的作用中工作階段。',
    resumeFailed: '繼續失敗',
    ...
    restartToUseSaveImage: '重新啟動 Allr Desktop 後可使用儲存圖片。',
    restartToSaveImages: '重新啟動 Allr Desktop 以儲存圖片',
    ...
    handoff: {
      ...
      timedOut: '等待閘道逾時。`allr gateway` 是否正在執行？'
    }
  },
  ...
  zones: {
    ...
    minimize: '最小化',
    restore: '還原',
    closeRunningTitle: '關閉正在執行的分頁？',
    closeRunningBody:
      '此對話仍在執行中（或正在等待你的輸入）。關閉分頁只會將其隱藏——工作階段會保留進度，可從側邊欄重新開啟。',
    ...
    pluginDisabledBody: '請在 設定 → 外掛 中重新啟用，即可讓窗格回來。',
    missingPane: paneId => `找不到窗格：${paneId}`,
    detach: '在新視窗中開啟',
    reattach: '重新嵌入',
    detachedBody: title => `${title} 已在另一個視窗中開啟。`,
    detachedMissing: '此視窗中沒有這個磚塊。',
    editTitle: '版面配置',
    editHint: '選擇一種版面配置，或在區域之間拖曳窗格。在區域上按右鍵可分割。',
    reset: '重設',
    templates: '範本',
    custom: '自訂',
    newGridLayout: '新增格線版面配置',
    saveCurrentAs: '將目前的排列儲存為範本',
    nameLayoutPlaceholder: '為這個版面配置命名…',
    deletePreset: name => `刪除 ${name}`,
    zoneEditorTitle: '區域編輯器',
    editorHintPre: '點擊分割 · ',
    editorHintPost: ' 翻轉分割線 · 拖過多個區域可合併 · 拖曳共用邊界可調整大小',
    templateColumns: '欄',
    templateRows: '列',
    templateGrid: '格線',
    templatePriority: '優先',
    ...
    layoutNamePlaceholder: fallback => `版面配置名稱（${fallback}）`,
    saveApply: '儲存並套用',
    notExpressible: '此排列互相咬合（風車形）——目前無法表示為巢狀分割',
  ...
  quickEntry: {
    label: '快速輸入',
    placeholder: '向 Allr 提問…',
    notConnected: '未連線——請開啟 Allr 重新連線',
    sendTo: '傳送到',
    currentChat: '目前對話',
    newSession: '新工作階段',
    targetLabel: '目標工作階段',
    settingsTitle: '快速輸入',
    settingsDesc: '用全域快速鍵隨時叫出小型輸入框，不必開啟 Allr 就能送出提示詞。',
    shortcutHint: '請在「鍵盤快速鍵」中為其指派快速鍵。'
  },
  webhooks: {
    title: 'Webhook',
    loading: '正在載入 Webhook…',
    loadFailed: 'Webhook 載入失敗',
    search: '搜尋訂閱…',
    noMatches: '沒有符合的訂閱。',
    tabInbound: '入站',
    tabOutbound: '出站',
    outboundSubtitle: '在 config.yaml 中設定',
    outboundTitle: '出站 Webhook',
    outboundBody:
      'Allr 可在工作階段生命週期掛鉤上向你自己的 URL 發送帶 HMAC 簽章的事件。它們在 config.yaml 的 `hooks.outbound:` 下設定——閘道未為其提供介面，因此這裡暫時無法管理。',
    emptyTitle: '尚無訂閱',
    emptyDesc: '訂閱會為外部服務提供一個可 POST 事件的 URL，並告訴智能體收到事件後要做什麼。',
    emptyDescDisabled: '請先啟用 Webhook 接收器——平台關閉時閘道會拒絕建立訂閱。',
    newSubscription: '新增訂閱',
    enableFirst: '請先啟用 Webhook 接收器。',
    rowActions: '訂閱操作',
    enableRow: '啟用',
    disableRow: '停用',
    showSecret: '顯示密鑰',
    ...
    fieldDescription: '描述',
    fieldDescriptionPlaceholder: '此訂閱的用途（選填）',
    fieldPrompt: '提示詞',
    fieldPromptPlaceholder: '觸發時智能體應做什麼（選填）',
    fieldEvents: '事件',
    fieldEventsPlaceholder: '以逗號分隔；留空符合所有事件',
    fieldSkills: '技能',
    fieldSkillsPlaceholder: '以逗號分隔的技能名稱（選填）',
    fieldDeliver: '投遞至',
    fieldDeliverChatId: '投遞對話 ID',
    fieldDeliverChatPlaceholder: '要投遞到的對話 / 頻道 ID（選填）',
    fieldDeliverChatDisabled: '請先選擇投遞目標',
    fieldDeliverOnly: '僅投遞裝載',
    fieldDeliverOnlyHint: '將原始事件轉送給目標，不執行智能體。',
    fieldSecret: '簽章密鑰',
    fieldSecretPlaceholder: '留空則自動產生',
    fieldSecretHint: '自動產生的密鑰只顯示一次，之後不再顯示。自帶密鑰可從一開始就保留副本。',
    fieldCreated: '建立於',
    fieldScript: '指令碼',
    secretSet: '已設定（已隱藏）',
    secretMissing: '未設定',
    createHint: '名稱會成為 URL 路徑，因此會轉為小寫、空格變為連字號。',
    create: '建立',
    creating: '正在建立…',
    createFailed: '無法建立訂閱',
    created: (name: string) => `已建立「${name}」`,
    nameRequired: '需要填寫名稱。',
    nameInvalid: '請使用小寫字母、數字、連字號與底線，並以字母或數字開頭。',
    nameNormalized: (name: string) => `將以「${name}」建立。`,
    deliverOnlyNeedsTarget: '僅投遞裝載需要真實目標——請選擇「日誌」以外的選項。',
    createdTitle: (name: string) => `「${name}」的密鑰`,
    secretOnce: '簽章密鑰',
    secretOnceWarning: '這是唯一一次顯示該密鑰。此後閘道在每次讀取時都會將其隱藏。',
    secretCopiedHint: '已複製到剪貼簿。關閉前請貼到安全的地方。',
    secretNotCopiedHint: '尚未複製。如果剪貼簿無法使用，請手動選取該值並複製。',
    secretRecovery: '遺失了？刪除此訂閱並重新建立——或下次自帶密鑰。',
    secretLater: '稍後',
    secretSaved: '我已儲存',
    enabledRow: (name: string) => `已啟用「${name}」`,
    disabledRow: (name: string) => `已停用「${name}」`,
    toggleFailed: (name: string) => `無法變更「${name}」`,
    deleteTitle: '刪除訂閱',
    deleteDescPrefix: '這將永久移除 ',
    deleteDescSuffix: '及其簽章密鑰。此操作無法復原。',
    deleting: '刪除中…',
    deleted: '訂閱已刪除',
    deleteFailed: (name: string) => `無法刪除「${name}」`,
    disabledTitle: 'Webhook 接收器已關閉',
    disabledBody:
      'Webhook 是獨立的閘道平台。啟用後即可接收傳入的 HTTP 事件；僅當訂閱需要投遞到聊天管道時才需要設定管道。',
    enable: '啟用 Webhook',
    enabling: '正在啟用…',
    enableFailed: '無法啟用 Webhook 平台',
    enabledRestartStarted: '已在設定中啟用，並已發起閘道重新啟動。重新啟動完成前接收器不會接受事件。',
    restartNotStarted: (detail: string) =>
      `已在設定中啟用，但閘道重新啟動未能開始${detail} 請手動重新啟動，接收器才能上線。`,
    restartGateway: '重新啟動閘道',
    restarting: '正在重新啟動…',
    receiverNotLiveTitle: '接收器未接受事件',
    receiverNotLive: (state: string) => `閘道回報 Webhook 平台狀態為「${state}」。下方訂閱已儲存，但目前沒有任何監聽。`,
    receiverUnknown: '此閘道不回報平台狀態，因此這裡無法確認接收器是否真的在監聽——只能確認它已在設定中啟用。',
    pendingRestartBody: 'Webhook 已在設定中啟用，但正在執行的閘道早於該變更啟動，尚未開啟接收器。請重新啟動它。',
    unknownState: '未知',
    deliverOptions: {
      log: '日誌',
      telegram: 'Telegram',
