...
export const zh: Translations = {
  ...
  settings: {
    ...
    gateway: {
      ...
      cloudDesc: '只需登录 Allr Cloud 一次，即可从你账户下的智能体中选择——无需粘贴 URL。',
      sshTitle: 'SSH',
      ...
      cloudSignIn: '登录 Allr Cloud',
      cloudSignedIn: '已登录 Allr Cloud',
      cloudNeedsSignIn: '登录 Allr Cloud 以发现你账户下的智能体。',
      ...
      cloudDiscoverFailed: '无法加载你的 Allr Cloud 智能体',
      cloudConnectFailed: '无法连接到该智能体',
      cloudSignInFailed: 'Allr Cloud 登录失败',
      cloudSignedOutTitle: '已退出 Allr Cloud',
      cloudSignedOutMessage: '已清除 Allr Cloud 会话。',
