...
//
// When someone is in a hands-free "Hey Allr" voice chat, the natural way to
...
// phrase (optionally addressed to Allr), so a real turn that merely contains
 ...
 * to Allr). Returns false for anything that merely contains "stop" as part of
