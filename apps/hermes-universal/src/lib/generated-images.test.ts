...
// Ported verbatim from apps/desktop/src/lib/generated-images.test.ts — the two
  ...
  it('prefers the host-visible image path', () => {
    expect(
      generatedImageFromResult({
        ...
        host_image: '/Users/me/.allr/cache/images/cat.png',
        image: '/Users/me/.allr/cache/images/cat.png',
        success: true
      })
    ).toBe('/Users/me/.allr/cache/images/cat.png')
  })
