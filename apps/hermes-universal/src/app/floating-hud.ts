...
// underline offset already sits at the bottom edge of a `text-xs` line box —
// together they clip the rule away entirely. Pulling the offset to 2px keeps it
// inside the box; dropping truncate costs nothing because these notes are one
// word.
