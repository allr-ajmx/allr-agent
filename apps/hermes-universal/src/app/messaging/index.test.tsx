...
// Full-mount integration test: settles in <100ms alone, but under the ~80-file
// parallel suite the CPU is saturated and can exceed vitest's 5s default. Give
// the async path room; correctness is unchanged. (Same as skills/index.test.tsx.)
...
describe('MessagingView setup-guide link', () => {
  ...
  it('opens a real docs URL through the validated external opener', async () => {
    const docsUrl = 'https://allr.work/docs/user-guide/messaging/teams'
