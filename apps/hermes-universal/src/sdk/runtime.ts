 ...
 * plugins (disk / gateway) import the same specifier and get the same object:
 ...
 *
 * The shim modules are `blob:` URLs, which is why `script-src` in
 * `src-tauri/tauri.conf.json` must allow `blob:`.
 */
