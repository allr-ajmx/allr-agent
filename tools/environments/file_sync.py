...
_FORCE_SYNC_ENV = "ALLR_FORCE_FILE_SYNC"
...
def iter_sync_files(container_base: str = "/root/.allr") -> list[tuple[str, str]]:
    ...
    the hardcoded /root/.allr to *container_base* because the remote
...
class FileSyncManager:
    ...
    def sync(self, *, force: bool = False) -> None:
        ...
        or ``ALLR_FORCE_FILE_SYNC=1`` is set.
    ...
    def sync_back(self, hermes_home: Path | None = None) -> None:
        ...
        Downloads the remote ``.allr/`` directory as a tar archive,
    ...
    def _sync_back_transaction(self, hermes_home: Path | None = None) -> None:
        ...
        # against an uninitialized remote .allr/ directory.
    ...
    def _infer_host_path(self, remote_path: str,
        ...
        For example, if the mapping has ``/root/.allr/skills/a.md`` →
        ``~/.allr/skills/a.md``, a new remote file at
        ``/root/.allr/skills/b.md`` maps to ``~/.allr/skills/b.md``.
        """
        mapping = file_mapping if file_mapping is not None else []
