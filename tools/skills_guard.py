...
Trust levels:
  - builtin:   Ships with Allr. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.allr/\.env|\~/\.allr/\.env',
     "hermes_env_access", "critical", "exfiltration",
     "directly references Allr secrets file"),
    ...
    (r'\.allr/config\.yaml|\.allr/SOUL\.md',
     "hermes_config_mod", "critical", "persistence",
     "references Allr configuration files directly"),
...
# scan. `.skillignore` is the Allr-native name; `.clawhubignore` is honored
