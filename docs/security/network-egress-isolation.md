...
When running Allr inside Docker, the default `network_mode: host` gives the
...
The Allr [SECURITY.md](../../SECURITY.md) §2 defines the trust model. The
...
#
# Usage:
#   ALLR_UID=$(id -u) ALLR_GID=$(id -g) docker compose up -d
#
...
- [SECURITY.md](../../SECURITY.md) — Allr trust model and vulnerability reporting
