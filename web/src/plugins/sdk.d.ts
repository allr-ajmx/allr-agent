/**
 * Allr Dashboard Plugin SDK — typed contract (SPIKE)
 * ====================================================
 *
 * This is the public type surface for ``window.__ALLR_PLUGIN_SDK__`` and
 * ``window.__ALLR_PLUGINS__``, the globals the dashboard host exposes to
 ...
 * window.__ALLR_PLUGIN_SDK__`` because:
 ...
 * of calling ``fetch`` with a hand-read ``window.__ALLR_SESSION_TOKEN__``.
 */
...
// ---------------------------------------------------------------------------
// Registry surface (window.__ALLR_PLUGINS__)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// SDK surface (window.__ALLR_PLUGIN_SDK__)
// ---------------------------------------------------------------------------
...
declare global {
  interface Window {
    __ALLR_PLUGIN_SDK__?: HermesPluginSDK;
    __ALLR_PLUGINS__?: PluginRegistry;
  }
}
