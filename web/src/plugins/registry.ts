 ...
 *
 * Plugins call window.__ALLR_PLUGINS__.register(name, Component)
 ...
 * Exposed at runtime as ``window.__ALLR_PLUGIN_SDK__.sdkVersion`` so a
...
export function exposePluginSDK() {
  window.__ALLR_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__ALLR_PLUGIN_SDK__ = {
    ...
    // window.__ALLR_SESSION_TOKEN__ directly.
    authedFetch,
