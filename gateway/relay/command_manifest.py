...
def build_relay_command_manifest() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        {"name": "reset", "description": "Reset your Allr session"},
        {
            "name": "model",
        ...
        {"name": "status", "description": "Show Allr session status"},
        {"name": "sethome", "description": "Set this chat as the home channel"},
        {"name": "stop", "description": "Stop the running Allr agent"},
        {
            "name": "steer",
        ...
        {"name": "update", "description": "Update Allr to the latest version"},
        {"name": "restart", "description": "Gracefully restart the Allr gateway"},
        {
            "name": "approve",
