...
portable, profile-relative phrase catalogs under ``ALLR_HOME`` either by using
conventional paths::

    ~/.allr/status_phrases.yaml
    ~/.allr/status_phrases/*.yaml
...
# These are Allr UI surfaces, not app/vendor/domain buckets.  Keep this
...
def classify_status_context(
    ...
    *,
    ...
    """Classify an internal gateway event into an Allr UI-surface bucket."""
