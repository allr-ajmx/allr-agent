...
Data file: $ALLR_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_ALLR_HOME = Path(os.environ.get("ALLR_HOME", Path.home() / ".allr"))
DATA_DIR = _ALLR_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
