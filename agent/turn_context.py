...
def build_turn_context(
    ...
    *,
    ...
    # Tag log records on this thread with the session ID for ``allr logs``.
    ...
    if agent.compression_enabled and _should_run_preflight_estimate(
        ...
        # Allr only initiates compaction in "hermes" mode (#36801).
        _codex_native_auto = (
        ...
        if _preflight_deferred:
            ...
            logger.info(
                "Skipping Allr preflight compression for codex app-server "
                "(mode=%s); Allr will not start thread compaction here.",
