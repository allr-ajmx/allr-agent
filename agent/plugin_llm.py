...
Plugins built on Allr often need to make their own LLM calls
...
Today the only stable plugin surfaces extend an existing Allr
...
handles every provider, fallback chain, and per-task override Allr
supports.
"""
