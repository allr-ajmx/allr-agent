...
_SESSION_CWD: ContextVar = ContextVar("ALLR_SESSION_CWD", default=_UNSET)
...
def resolve_context_cwd() -> Path | None:
    ...
    # configured path is otherwise honored verbatim — including the Allr
    # source tree itself, which is a legitimate workspace when the user is
    # developing Allr (per-surface policy for fallback-picked directories
