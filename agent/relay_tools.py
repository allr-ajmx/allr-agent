"""Core NeMo Relay adapter for Allr tool execution."""
    ...
    try:
        ...
        if (
            ...
            logger.warning(
                ...
                "returning the Allr tool result",
                exc_info=True,
            )
...
def _run_awaitable(value: Any) -> Any:
    ...
    raise RuntimeError(
        "Synchronous Allr Relay tool execution cannot run on an active event-loop thread"
    )
