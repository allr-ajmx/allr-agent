...
* **Zero LLM turn.** This is a deterministic export — it never spends a
  model call. The ``allr trace upload`` subcommand calls
...
# ---------------------------------------------------------------------------
# Conversion: Allr OpenAI-format messages -> Claude Code JSONL
# ---------------------------------------------------------------------------
...
def build_trace_jsonl(
    ...
    *,
    ...
    """Render Allr conversation messages as Claude Code JSONL text.
...
_NO_TOKEN_MESSAGE = (
    ...
    "2. Add it to your environment as HF_TOKEN (e.g. in ~/.allr/.env):\n"
    "     HF_TOKEN=hf_xxxxxxxxxxxxxxxxxxxx\n"
    "3. Run /upload-trace again (or `allr trace upload`)."
)
