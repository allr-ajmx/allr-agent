"""Vertex AI (Google Cloud) adapter for Allr.

Provides authentication and configuration for Vertex AI's OpenAI-compatible
endpoint. This allows Allr to use Gemini models via Google Cloud with
...
# who installed plain `allr-agent` and only later selected a Gemini model.
try:
